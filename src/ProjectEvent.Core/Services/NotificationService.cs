...
namespace ProjectEvent.Core.Services
{
    public class NotificationService
    {
        ...
        public void ShowNotification(string title, string content, ToastScenarioType toastScenarioType = ToastScenarioType.Default, string img = null)
        {
            string imgChild = !string.IsNullOrEmpty(img) ? $@"<image placement=""appLogoOverride"" hint-crop=""circle"" src=""{img}""/>" : "";
            string xml = $@"<toast scenario=""{toastScenarioType}"">
                      <visual>
