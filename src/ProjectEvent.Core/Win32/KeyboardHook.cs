...
namespace ProjectEvent.Core.Win32
{
    ...
    public class KeyboardHook
    {
        ...
        public KeyboardHook()
        {
            foreach (var item in KeyboardWin32API.KeysMap)
            {
                KeyMap.Add(item.Value, item.Key);
            }
        }
        public string ToKeyString(int key)
        {
            return KeyMap.ContainsKey(key) ? KeyMap[key] : "Unknown";
        }
        public void Start()
        {
            // 安装键盘钩子
        ...
        private int KeyboardHookProc(int nCode, Int32 wParam, IntPtr lParam)
        {
            ...
            if ((nCode >= 0) && (KeyDownEvent != null || KeyUpEvent != null || KeyPressEvent != null))
            {
                ...
                {
                    KeyDownEvent(MyKeyboardHookStruct.vkCode);
                }
                ...
                if (KeyPressEvent != null && wParam == WM_KEYDOWN)
                {
                    ...
                    if (ToAscii(MyKeyboardHookStruct.vkCode, MyKeyboardHookStruct.scanCode, keyState, inBuffer, MyKeyboardHookStruct.flags) == 1)
                    {
                        ...
                        KeyPressEvent(MyKeyboardHookStruct.vkCode);
                    }
                }
                ...
                {
                    KeyUpEvent(MyKeyboardHookStruct.vkCode);
                }
